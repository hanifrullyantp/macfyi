...
export const Dashboard = ({
  ...
  return (
    <div className="relative z-10 flex flex-col h-full overflow-y-auto custom-scrollbar px-6 py-6 md:px-8 pb-28">
      <div className="max-w-5xl w-full mx-auto space-y-6">
        <div className="relative rounded-2xl border border-white/[0.06] bg-[#0a0b0f]/55 px-5 py-4 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
          <h1 className="text-[34px] leading-[40px] font-semibold text-white tracking-tight flex items-center gap-2 drop-shadow-sm">
            Smart Care <Sparkles className="text-[var(--color-accent-text)]" size={24} />
          </h1>
          <p className="text-sm text-white/65 mt-1">
            Clean confidently with AI-guided, local-first recommendations.
          </p>
        </div>
