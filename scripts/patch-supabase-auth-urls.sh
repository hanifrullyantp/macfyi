...
URI_ALLOW_LIST="${AUTH_URI_ALLOW_LIST:-https://macfyi.com/**,https://macfyi.com/admin,https://macfyi.com/admin/**,https://adm.macfyi.com,https://adm.macfyi.com/**,https://www.macfyi.com/**,http://localhost:5173/**,http://127.0.0.1:5173/**,http://localhost:3000/**,http://127.0.0.1:3000/**}"
