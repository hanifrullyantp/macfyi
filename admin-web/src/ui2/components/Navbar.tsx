      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="flex items-center gap-3 p-1.5 pl-3 hover:bg-white/5 rounded-full transition-all border border-transparent hover:border-white/10"
          ...
          >
            ...
            <ChevronDown className={`h-4 w-4 text-white/40 transition-transform ${menuOpen ? "rotate-180" : ""}`} />
          </button>
          {menuOpen ? (
            <div
              role="menu"
